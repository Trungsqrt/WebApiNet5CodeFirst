...
**MyDbContext.cs**
After create class present for table, let configure the table and entity properties.

**Declare the DbSet for tables**
```c#
public DbSet<DonHang> DonHangs { get; set; }
public DbSet<DonHangChiTiet> DonHangChiTiets { get; set; }
```

**override the `OnModelCreating` to config entity and table properties**
```c#
...
```
**So `add-migration` and `update-database` **
